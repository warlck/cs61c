...
main:	jal	create_default_list
	...
	### YOUR CODE HERE ###
	la    $a1, square #function we are working with//correct?
	jal	map
...
map:
	...
	### YOUR CODE HERE ###
	jal 	square #or jalr #is it square or map
	# store the returned value back into the node
	### YOUR CODE HERE ###
	sw		$s0, 0($a0) #not sure if first term is correct
	# load the address of the next node into $a0
	### YOUR CODE HERE ###
	lw		$a0, 4($s0) #this part holds the next pointer address
	# put the address of the function back into $a1 to prepare for the recursion
	### YOUR CODE HERE ###
	move $a1, $s1 #think its this from line 49
	#recurse
	### YOUR CODE HERE ###
	jal map
